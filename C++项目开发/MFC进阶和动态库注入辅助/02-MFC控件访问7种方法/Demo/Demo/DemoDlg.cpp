...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Text(pDX, IDC_EDIT_A, m_edit_int_a);
	DDV_MinMaxInt(pDX, m_edit_int_a, 0, 100);
	DDX_Text(pDX, IDC_EDIT_B, m_edit_int_b);
	DDV_MinMaxInt(pDX, m_edit_int_b, 0, 100);
	DDX_Text(pDX, IDC_EDIT_C, m_edit_int_c);
	DDV_MinMaxInt(pDX, m_edit_int_c, 0, 100);
	DDX_Control(pDX, IDC_EDIT_A, m_edit_contral_a);
	DDX_Control(pDX, IDC_EDIT_B, m_edit_contral_b);
	DDX_Control(pDX, IDC_EDIT_C, m_edit_contral_c);
}
...
BEGIN_MESSAGE_MAP(CDemoDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_ADD7, &CDemoDlg::OnBnClickedButtonAdd7)
END_MESSAGE_MAP()
...
void CDemoDlg::OnBnClickedButtonAdd1()
{
	...
	GetDlgItem(IDC_EDIT_A)->GetWindowTextW(chs1, N);
	GetDlgItem(IDC_EDIT_B)->GetWindowTextW(chs2, N);

	int a = _ttoi(chs1), b = _ttoi(chs2);
	int c = a + b;

	// 10 代表 十进制显示
	_itow_s(c, chs3, 10);

	GetDlgItem(IDC_EDIT_C)->SetWindowTextW(chs3);
}
...
void CDemoDlg::OnBnClickedButtonAdd2()
{
	...
	//GetDlgItemText(IDC_EDIT_A, chs1, N);
	//GetDlgItemText(IDC_EDIT_B, chs2, N);
...
void CDemoDlg::OnBnClickedButtonAdd4()
{
	...
	m_edit_int_c = m_edit_int_a + m_edit_int_b;
...
{
	CString str1, str2;
	m_edit_contral_a.GetWindowTextW(str1);
	m_edit_contral_b.GetWindowTextW(str2);

	// CString 转 int
	int a = _ttoi(str1), b = _ttoi(str2);
	...
	m_edit_contral_c.SetWindowTextW(str3);
}
...
void CDemoDlg::OnBnClickedButtonAdd7()
{
	TCHAR chs1[N], chs2[N], chs3[N];
