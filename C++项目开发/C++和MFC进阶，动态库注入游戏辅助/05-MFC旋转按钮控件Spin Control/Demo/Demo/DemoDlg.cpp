...
BEGIN_MESSAGE_MAP(CDemoDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(UDN_DELTAPOS, IDC_SPIN3, &CDemoDlg::OnDeltaposSpin3)
END_MESSAGE_MAP()
...
BOOL CDemoDlg::OnInitDialog()
{
	...
	// TODO: 在此添加额外的初始化代码
	m_spin1.SetRange(-10, 10);
	m_spin1.SetPos(3);

	m_spin2.SetBuddy(GetDlgItem(IDC_EDIT2));
...
void CDemoDlg::OnDeltaposSpin3(NMHDR* pNMHDR, LRESULT* pResult)
{
