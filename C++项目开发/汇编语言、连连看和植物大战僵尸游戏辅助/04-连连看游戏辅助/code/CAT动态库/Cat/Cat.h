...
// 线程回调函数
// DWORD WINAPI ThreadProc(LPVOID lpParameter);	// 函数名自定义 参数可以为NULL
...
public:
	...
	virtual HANDLE CreateThread(LPTHREAD_START_ROUTINE  lpStartAddress) = 0;
	...
	virtual void WriteMemory(HANDLE hProcess, void* value, DWORD valueSize, ...) = 0;
	virtual void WriteMemory(HANDLE hProcess, void* value, DWORD valueSize, DWORD address) = 0;
	...
	// 系统
	virtual BOOL ImproveAccessPrivilege() = 0;
...
public:
	...
	virtual HANDLE CreateThread(LPTHREAD_START_ROUTINE  lpStartAddress);
	...
	virtual void WriteMemory(HANDLE hProcess, void* value, DWORD valueSize, ...);
	virtual void WriteMemory(HANDLE hProcess, void* value, DWORD valueSize, DWORD address);
	...
	// 系统
	virtual BOOL ImproveAccessPrivilege();
};
